...
def dibujar_grafo(grafo, ubicaciones):
    ...
    for nodo, aristas in grafo.aristas.items():
        x1, y1 = ubicaciones[nodo]
        for arista in aristas:
            x2, y2 = ubicaciones[arista[0]]
            pygame.draw.line(ventana, (0, 0, 0), (x1, y1), (x2, y2), 2)
    for nodo in grafo.nodos:
        x, y = ubicaciones[nodo]
        pygame.draw.circle(ventana, (0, 0, 255), (x, y), 20)
        ventana.blit(fuente.render(nodo, True, (0, 0, 0)), (x - 10, y - 10))
...
def main():
    ...
    botones = [
        {'text': 'Recoger en A', 'rect': pygame.Rect(10, 10, 100, 40), 'color': (0, 128, 0), 'accion': lambda: 'A'},
        {'text': 'Recoger en B', 'rect': pygame.Rect(10, 60, 100, 40), 'color': (0, 128, 0), 'accion': lambda: 'B'},
        {'text': 'Recoger en C', 'rect': pygame.Rect(10, 110, 100, 40), 'color': (0, 128, 0), 'accion': lambda: 'C'},
            ...
            if evento.type == QUIT:
                ...
                for boton in botones:
                    if boton['rect'].collidepoint(evento.pos):
                        ...
                        elif boton['text'].startswith('Destino'):
